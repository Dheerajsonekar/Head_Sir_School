...
export default function PrincipalDashboard() {
  ...
  const stats = [
    { title: 'Total Teachers', value: '45', icon: Users, color: 'bg-blue-500', change: '+5%' },
    { title: 'Total Students', value: '1,240', icon: GraduationCap, color: 'bg-green-500', change: '+12%' },
    { title: 'Active Classes', value: '28', icon: BookOpen, color: 'bg-purple-500', change: '+2%' },
    { title: 'Performance Rate', value: '94%', icon: TrendingUp, color: 'bg-orange-500', change: '+8%' },
  ];
